...
@ПримерИспользования: И _00100 загружаю константы

Сценарий: _00100 Загружаю константы
...
Сценарий: _00101 Создание объектов для справочника Валюты
...
Сценарий: _00102 Создание объектов для справочника Организации
